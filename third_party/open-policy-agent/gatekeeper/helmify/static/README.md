...
| controllerManager.image.tag                                     | Image tag                                                                                                                                                                                                                                    | Current release version: `v1.1.0-beta.1` |
...
| eraser.image.tag                               | Image tag for worker                                                                                                                                                                                                                                    | Current release version: `v1.1.0-beta.1` |
